...
//  exposed in the dll file HarmonoiseP2P.dll, version 2.2, which implements
...
namespace HarmonoiseInCSharp
{
    ...
    public class PointToPoint
    {
        ...
        IntPtr _p2pStruct;  // reference to C++ P2P object
        ...
        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_Create",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern IntPtr P2P_Create();

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_Delete",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern void P2P_Delete(IntPtr x);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetVersionDLL",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern double P2P_GetVersionDLL(IntPtr x);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetNbFreq",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_GetNbFreq(IntPtr x);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetFreq",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern double P2P_GetFreq(IntPtr x, int Index);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetFreqArray",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_SetFreqArray(IntPtr x, int NFreq, ref double f);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetBandwidth",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern double P2P_GetBandwidth(IntPtr x);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetBandwidth",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_SetBandwidth(IntPtr x, double bw);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetOptions",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern UInt32 P2P_GetOptions(IntPtr x);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetOptions",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern UInt32 P2P_SetOptions(IntPtr x, UInt32 opt);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetSourceHeight",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern double P2P_GetSourceHeight(IntPtr x);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetSourceHeight",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_SetSourceHeight(IntPtr x, double h, double dh);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetReceiverHeight",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern double P2P_GetReceiverHeight(IntPtr x);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetReceiverHeight",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_SetReceiverHeight(IntPtr x, double h, double dh);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetSoundSpeed",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern double P2P_GetSoundSpeed(IntPtr x);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetSoundSpeed",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_SetSoundSpeed(IntPtr x, double h);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetupAirAbsorption",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_SetupAirAbsorption(IntPtr x, double temp, double hum);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetAirAbsorption",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_SetAirAbsorption(IntPtr x, ref double a);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetAirAbsorption",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_GetAirAbsorption(IntPtr x, ref double a);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetSoundSpeedProfile",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_SetSoundSpeedProfile(IntPtr x, double a, double b, double c, double d);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetSoundSpeedProfile",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_GetSoundSpeedProfile(IntPtr x, ref double a, ref double b, ref double c, ref double d);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetImpedanceDB",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_SetImpedanceDB(IntPtr x, int Index, double sigma, double thickness);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetImpedanceRI",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_SetImpedanceRI(IntPtr x, int Index, ref double Z);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetImpedanceDB",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_GetImpedanceDB(IntPtr x, int Index, ref double sigma, ref double thickness);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetImpedanceRI",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_GetImpedanceRI(IntPtr x, int Index, ref double Z);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetSegmentSplitFactor",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_GetSegmentSplitFactor(IntPtr x);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetSegmentSplitFactor",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_SetSegmentSplitFactor(IntPtr x, int factor);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_Clear",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_Clear(IntPtr x);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_AddSegment",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_AddSegment(IntPtr x, double sx, double sy, int impedanceIndex);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetResults",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_GetResults(IntPtr x, ref double att);

        /*     Not implemented because results are not necessarily correct
               [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetRayCurvature",
               SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
               static extern double P2P_GetRayCurvature(IntPtr x);
       */
        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetRayCurvature",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern double P2P_SetRayCurvature(IntPtr x, double invR);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetNbDetails",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_GetNbDetails(IntPtr x);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetDetails",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_GetDetails(IntPtr x, int Index, ref int model,
            ref int src, ref int rec, ref int dif, ref double att);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_GetTimerCPU",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern double P2P_GetTimerCPU(IntPtr x, bool reset);

        [DllImport("HarmonoiseP2P.dll", EntryPoint = "P2P_SetupMeteoParameters",
        SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        static extern int P2P_SetupMeteoParameters(IntPtr x, double windSpeed,
            double cosWind, int stabilityClass);
        #endregion
        ...
        // The basic met parameters A, B, C, D can be set and read directly, or set only by using InverseRayCurvature
        //   or SetMetParameters (which is overloaded)
        ...
        public double InverseRayCurvature
        {
            set { P2P_SetRayCurvature(_p2pStruct, value); }
        }
